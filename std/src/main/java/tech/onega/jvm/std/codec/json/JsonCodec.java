...
final public class JsonCodec {
  ...
  private static final JacksonMapper MAPPER = new JacksonMapper(ObjectMapper::new);

  public static ObjectMapper createObjectMapper() {
    return MAPPER.createObjectMapper();
  }

  public static <T> T parse(final byte[] json, final Class<T> type) {
    return MAPPER.parse(json, type);
  }

  public static <T> T parse(final File file, final Class<T> type) {
    return MAPPER.parse(file, type);
  }

  public static <T> T parse(final IBytes json, final Class<T> type) {
    return MAPPER.parse(json, type);
  }
  ...
  public static <T> T parse(final String json, final Class<T> type, final Charset charset) {
