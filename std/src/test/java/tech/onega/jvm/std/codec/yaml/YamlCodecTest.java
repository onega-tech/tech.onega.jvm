...
public class YamlCodecTest {
  ...
  public void test() {
    ...
    final var yaml = YamlCodec.toString(from);
    final var to = YamlCodec.parse(yaml, To.class);
  ...
  public void testInstant() {
    ...
    final var yaml = YamlCodec.toString(instant);
    final var fromYaml = YamlCodec.parse(yaml, Instant.class);
    Check.equals(instant.toEpochMilli(), fromYaml.toEpochMilli());
  }
